...
const Home = props => {
	const [que, setQue] = useState(
		[
			{path: '/question/1', imgSrc: 'https://media.giphy.com/media/zGk5I6VUTBQRrTxTmf/giphy.gif', questionText: 'Do you wanna eat in Çatı?' },
			{path: '/question/2', imgSrc: 'https://media.giphy.com/media/Q47i2kDz8w1utetr7i/giphy.gif', questionText: 'Can you do this move for me?' },
			{path: '/question/3', imgSrc: 'https://media.giphy.com/media/yl3xCL7IMbMxwscPlm/giphy.gif', questionText: 'Do you want go to club?' },
